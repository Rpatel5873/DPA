...
public class RBMMultipleCaseSavedEventTests extends PostTests {
    ...
    @Test(dataProvider = "RBMCaseSavedEvent", dataProviderClass = DataProviders.class)
    public void whenRBMMultipleCaseSaveEventIsTriggeredThroughTibcoServiceByProvidingValidAttachmentIdAndCPTCodeThenApplicationStatusQueryServiceResponseShouldContainUniqueTransactionIdAlongWithCPTCodeAndAttachmentId(String CPT, String productId, String eventTypeCode, String publisherApplicationId, String publisherEventId, String productName, String DOB, String clientId, String houseAccountMemberFlag) throws Exception {
