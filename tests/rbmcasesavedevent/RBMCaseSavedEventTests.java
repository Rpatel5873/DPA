...
import static com.aim.dnaautomation.helpers.constants.BasePathConstants.SEND_ATTACHMENT_TO_DNA_PROCESSOR;
import static com.aim.dnaautomation.helpers.rabbitmqconstants.Constants.*;

public class RBMCaseSavedEventTests extends PostTests {

    private CustomFilterableRequestSpecification requestSpecification;

    @BeforeClass
    public void init() {
        basePath = SEND_ATTACHMENT_TO_DNA_PROCESSOR;
