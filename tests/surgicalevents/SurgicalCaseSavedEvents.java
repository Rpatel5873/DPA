package com.aim.dnaautomation.tests.surgicalevents;
...
public class SurgicalCaseSavedEvents extends PostTests {
    ...
    @Test(dataProvider = "SurgicalCaseSavedEvents", dataProviderClass = DataProviders.class)
    public void whenSurgicalCaseSavedEventsIsTriggeredThroughTibcoServiceByProvidingValidAttachmentIDCPTThenApplicationStatusQueryServiceResponseShouldContainUniqueTransactionIdAlongWithCPTCodeAndAttachmentIdAndPolicyIdAsTC_CN_ONLY(String CPT, String productId, String eventTypeCode, String publisherApplicationId, String publisherEventId, String productName, String DOB, String clientId, String houseAccountMemberFlag) throws Exception {
        ...
        TibcoServiceUtility caseSave = new TibcoServiceUtility(requestSpecification, CONNECTION_ID_SURG, PRODUCT_ID_SURG, EVENT_TYPE_CD_SURG, PUBLISHER_APPLICATION_ID_SURG, PUBLISHER_EVENT_ID_SURG);
