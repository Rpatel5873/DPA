...
public class MSKCaseSavedEventTests extends PostTests {
    ...
    public void whenMSKCaseSavedEventIsTriggeredThroughTibcoServiceByProvidingValidAttachmentIDCPTThenApplicationStatusQueryServiceResponseShouldContainUniqueTransactionIdAlongWithCPTCodeAndAttachmentIdAndPolicyIdAsTC_CN_ONLY(String CPT, String productId, String eventTypeCode, String publisherApplicationId, String publisherEventId, String productName, String DOB, String clientId, String houseAccountMemberFlag) throws Exception {
