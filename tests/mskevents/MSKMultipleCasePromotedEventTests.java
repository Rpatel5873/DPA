...
public class MSKMultipleCasePromotedEventTests extends PostTests {
    ...
    public void whenMSKMultipleCasePromotedEventIsTriggeredThroughTibcoServiceByProvidingValidAttachmentIDCPTThenApplicationStatusQueryServiceResponseShouldContainUniqueTransactionIdAlongWithCPTCodeAndAttachmentIdAndPolicyIdAsTC_CN_ONLY(String CPT, String productId, String eventTypeCode, String publisherApplicationId, String publisherEventId, String productName, String DOB, String clientId, String houseAccountMemberFlag) throws Exception {
