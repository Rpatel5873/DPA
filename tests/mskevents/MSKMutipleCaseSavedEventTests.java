...
public class MSKMutipleCaseSavedEventTests extends PostTests {
    ...
    @Test(dataProvider = "MSKCaseSavedEvents", dataProviderClass = DataProviders.class)
    public void whenMSKMutipleCaseSavedEventIsTriggeredThroughTibcoServiceByProvidingValidAttachmentIDCPTThenApplicationStatusQueryServiceResponseShouldContainUniqueTransactionIdAlongWithCPTCodeAndAttachmentIdAndPolicyIdAsTC_CN_ONLY(String CPT, String productId, String eventTypeCode, String publisherApplicationId, String publisherEventId, String productName, String DOB, String clientId, String houseAccountMemberFlag) throws Exception {
