...
public class TATReopenLackofInfoResponse30ConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenLackofInfoResponse(30).json";
