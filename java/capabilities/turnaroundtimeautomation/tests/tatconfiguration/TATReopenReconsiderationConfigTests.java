...
public class TATReopenReconsiderationConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenReconsideration.json";
