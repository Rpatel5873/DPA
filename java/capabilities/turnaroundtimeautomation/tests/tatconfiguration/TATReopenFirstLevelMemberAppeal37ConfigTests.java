...
public class TATReopenFirstLevelMemberAppeal37ConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenFirstLevelMemberAppeal(37).json";
