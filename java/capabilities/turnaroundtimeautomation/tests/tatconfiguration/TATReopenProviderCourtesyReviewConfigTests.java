...
public class TATReopenProviderCourtesyReviewConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenProviderCourtesyReview.json";
