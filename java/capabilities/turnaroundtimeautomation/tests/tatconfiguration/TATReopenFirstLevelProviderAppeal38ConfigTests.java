...
public class TATReopenFirstLevelProviderAppeal38ConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenFirstLevelProviderAppeal(38).json";
