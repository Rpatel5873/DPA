...
public class CaseToTurnAroundTimedtoMapper extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/caseToTurnAroundTimedtoMapper_nodes.json";
