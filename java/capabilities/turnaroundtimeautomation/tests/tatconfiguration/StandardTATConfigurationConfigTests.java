...
public class StandardTATConfigurationConfigTests extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/StandardTATConfiguration.json";
