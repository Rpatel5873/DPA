...
public class TurnAroundTimeProviderCourtesyReviewConfigTestsPROD extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TurnAroundTimeProviderCourtesyReviewPROD.json";
