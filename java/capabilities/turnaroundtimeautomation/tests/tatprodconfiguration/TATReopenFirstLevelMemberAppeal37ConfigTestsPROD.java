...
public class TATReopenFirstLevelMemberAppeal37ConfigTestsPROD extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenFirstLevelMemberAppeal(37)PROD.json";
