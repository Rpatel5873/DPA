...
public class TATReopenReconsiderationConfigTestsPROD extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenReconsiderationPROD.json";
