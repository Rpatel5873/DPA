...
public class TATReopenFirstLevelProviderAppeal38ConfigTestsPROD extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenFirstLevelProviderAppeal(38)PROD.json";
