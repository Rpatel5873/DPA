...
public class TATReopenLackofInfoResponse30ConfigTestsPROD extends ClientConfigHelperTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenLackofInfoResponse(30)PROD.json";
