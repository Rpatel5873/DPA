...
import static com.aim.dnaautomation.helpers.rabbitmqconstants.Constants.PROVIDER_DOCUMENTATION_REVIEW;

public class TATReopenProviderDocumentationReviewPRODCalculationTests extends ClientConfigBaseTest {
    private static final String FILE_NAME = "clientconfigurations/TATReopenProviderDocumentationReviewPRODCalculation.json";

    @DataProvider(name = "TATReopenProviderDocumentationReviewPRODCalculationTests")
    private Object[][] TATReopenProviderDocumentationReviewPRODCalculationTests() {
        return loadTestCaseDTOsFromJson(FILE_NAME);
    }

    @Test(dataProvider = "TATReopenProviderDocumentationReviewPRODCalculationTests")
    public void TATReopenProviderDocumentationReviewPRODCalculationTests(ClientConfigTestCaseDTO testCaseDTO) throws JsonProcessingException {
        ...
        TATResponseDTO response = new TurnAroundTimeSteps(requestSpecification).CalculateTurnAroundTimeStepsForPRODTATCalculation(requestSpecification, testCaseDTO, routerresponse, PROVIDER_DOCUMENTATION_REVIEW);
