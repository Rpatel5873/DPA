...
public class CalendarDayTATCalculationTests extends ClientConfigBaseTest {
    private static final String FILE_NAME = "clientconfigurations/calendarDaysTATCalculation.json";

    @DataProvider(name = "calendarDayCalculationTestCases")
    private Object[][] calendarDayCalculationTestCases() {
        return loadTestCaseDTOsFromJson(FILE_NAME);
    }

    @Test(dataProvider = "calendarDayCalculationTestCases")
    public void calendarDayCalculationTestCases(ClientConfigTestCaseDTO testCaseDTO) throws JsonProcessingException {
